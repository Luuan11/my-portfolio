...
### <p align="center"> <a href="https://luuan11.vercel.app/">Click here to see my project!</a> </p>
...
- ✨ **Smooth Animations** - Elegant transitions and scroll-based reveals
- 🎯 **Interactive Carousel** - Showcase projects with intuitive navigation
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/Luuan11/my-portfolio.git
   cd my-portfolio
   ```
