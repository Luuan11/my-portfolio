...
const academicEducation = [
   {
    institution: 'Go Expert Full Cycle',
    degree: "Postgraduate Degree in Information Systems",
    period: '2024 - 2025',
    location: 'Brazil',
  ...
  {
    institution: 'Faculdade Uninove Nove de Julho',
          ...
          <div className="academic-grid">
            {academicEducation.map((edu, index) => (
              <div 
                ...
                className={`academic-card scroll-reveal scroll-reveal-delay-${index + 1} ${cardVisible ? 'is-visible' : ''}`}
              >
                <div className="academic-header">
                  ...
                  <div className="academic-info">
                    ...
                    <div className="academic-meta">
                      <span className="academic-period">{edu.period}</span>
                      <span className="academic-location">{edu.location}</span>
                    </div>
                  </div>
                </div>
          ...
          <div className="certifications-grid">
            {certifications.map((cert, index) => (
              <div 
                key={index}
                ref={cardRef as React.RefObject<HTMLDivElement>}
                className={`certification-card scroll-reveal scroll-reveal-delay-${(index % 3) + 1} ${cardVisible ? 'is-visible' : ''}`}
              >
